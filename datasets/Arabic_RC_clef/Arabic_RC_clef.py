...
class Arabic_RC_clef(datasets.GeneratorBasedBuilder):
	def _info(self):
	...
	def _split_generators(self, dl_manager):
		url = ['https://raw.githubusercontent.com/MariamBiltawi/Arabic_RC_datasets/main/data/updated_clef_dataset.xlsx']
