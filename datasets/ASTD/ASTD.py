...
class ASTD(datasets.GeneratorBasedBuilder):
	def _info(self):
		return datasets.DatasetInfo(features=datasets.Features({'tweet':datasets.Value('string'),'label': datasets.features.ClassLabel(names=['NEUTRAL', 'OBJ', 'POS', 'NEG'])}))
